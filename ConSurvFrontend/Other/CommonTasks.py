...
def common_tasks():
    ...
    tf.tfcps_Tools_General.generate_api_client_from_dependent_codeunit(tf.get_codeunit_folder(),"ConSurvBackend","con-surv-backend", "typescript-angular",tf.use_cache())
