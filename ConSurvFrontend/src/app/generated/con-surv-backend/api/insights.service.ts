...
export class InsightsService extends BaseService {
     ...
     */
    public aPIV1InsightsControllerGetMediaMTXConfigurationCameraIdGet(xAccessToken: string, cameraId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<CameraDTO>;
    public aPIV1InsightsControllerGetMediaMTXConfigurationCameraIdGet(xAccessToken: string, cameraId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<CameraDTO>>;
    public aPIV1InsightsControllerGetMediaMTXConfigurationCameraIdGet(xAccessToken: string, cameraId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<CameraDTO>>;
    public aPIV1InsightsControllerGetMediaMTXConfigurationCameraIdGet(xAccessToken: string, cameraId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (xAccessToken === null || xAccessToken === undefined) {
            throw new Error('Required parameter xAccessToken was null or undefined when calling aPIV1InsightsControllerGetMediaMTXConfigurationCameraIdGet.');
        }

        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
          <any>cameraId, 'cameraId');
        ...
        let localVarPath = `/API/v1/InsightsController/GetMediaMTXConfiguration/cameraId`;
