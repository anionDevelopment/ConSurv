...
export class UserService extends BaseService {
    ...
    public aPIV3UserControllerCreateUserPut(xAccessToken: string, user?: string, password?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public aPIV3UserControllerCreateUserPut(xAccessToken: string, user?: string, password?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (xAccessToken === null || xAccessToken === undefined) {
            throw new Error('Required parameter xAccessToken was null or undefined when calling aPIV3UserControllerCreateUserPut.');
        }
        ...
        let localVarPath = `/API/v3/UserController/CreateUser`;
     ...
     * @endpoint get /API/v3/UserController/GetTheme
     * @param xAccessToken Access Token
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param options additional options
    ...
    public aPIV3UserControllerLoginPut(xUser?: string, xPassword?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<AccessToken>>;
    public aPIV3UserControllerLoginPut(xUser?: string, xPassword?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
     ...
     * @endpoint put /API/v3/UserController/SetTheme
     * @param xAccessToken Access Token
