...
This technical reference refers to the [codeunit](https://github.com/anionDev/ConSurv/ConSurv) `ConSurv`.
For the reference of the product `ConSurv` see the [GitHub-page](https://github.com/anionDev/ConSurv).
