...
Domain-logic SHALL exist only in the business-logic-service (`ConSurvBackend/ConSurvBackend/Services/BusinessLogicService.cs`). Controllers, middlewares,
...
codeunit in its `<codeunit-name>.codeunit.xml`. The codeunits of this repository are: ConSurv, ConSurvApp, ConSurvBackend, ConSurvFrontend.
