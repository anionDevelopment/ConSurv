...
try {
    final result = api_instance.aPIV3InsightsControllerGetRunningProcessesGet(xAccessToken);
    print(result);
} catch (e) {
    print('Exception when calling InsightsApi->aPIV3InsightsControllerGetRunningProcessesGet: $e\n');
}
```
